    ...
    <>
      <style>{`
        @media print {
          ...
          .invoice-slip { height: 148.5mm; padding: 8mm 12mm; box-sizing: border-box; }
            ...
            {pair.map((invoice, slipIdx) => {
              ...
              return (
                <div key={invoice.id} className="relative">
                  <div
                    className="invoice-slip border rounded-lg p-4 mx-auto mb-3 max-w-2xl print:max-w-none print:rounded-none print:border-0 print:border-b print:border-dashed print:border-gray-400 print:mx-0 print:mb-0"
                  >
                    {/* Header */}
                  ...
                  {/* Cut line — screen only */}
                  {showCutLine && (
                    <div className="print:hidden flex items-center gap-2 px-4 my-1 max-w-2xl mx-auto">
